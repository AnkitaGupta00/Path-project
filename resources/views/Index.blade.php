                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-data__tool">
                            ...
                            <div class="table-data__tool-right">
                                {{--                                <a href="{{url('register')}}" class="btn btn-primary" style="margin-left: 25px; margin-top: 20px">--}}
                                {{--                                    Add tasks +--}}
                                {{--                                </a>--}}
                        ...
                        <div class="table-responsive table-responsive-data2">
                            <table class="table table-data2">
                                ...
                                @foreach($project as $item)
                                    <tr class="tr-shadow">
                                        <td>{{$item->title ?? ''}}</td>
                                        <td>{{\App\Models\tasks::count()}}</td>
                                        <td>
                                            <div class="table-data-feature">
                                                <a href="{{url('makeTask')}}" class="item" data-toggle="tooltip" data-placement="top" title="" data-original-title="Send">
