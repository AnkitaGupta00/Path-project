        ...
        <section class="welcome p-t-10">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="title-4">
                            Tasks - <?php echo e(\App\Models\project::count('id')); ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-data__tool">
                            ...
                            <div class="table-data__tool-right">
                                ...
                                <button class="au-btn au-btn-icon au-btn--green au-btn--small"></button>
                                    <button type="button" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Add Project</button>
                            ...
                            <table class="table table-data2">
                                ...
                                <?php $__currentLoopData = $project; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="tr-shadow">
                                        ...
                                        <td><?php echo e(\App\Models\tasks::count()); ?></td>
                                        <td>
                                            <div class="table-data-feature">
                                                <a href="<?php echo e(url('makeTask')); ?>" class="item" data-toggle="tooltip" data-placement="top" title="" data-original-title="Send">
...
<!-- end document-->
<?php /**PATH /home/ankita/work/web/laravel/path-project/resources/views/Index.blade.php ENDPATH**/ ?>
