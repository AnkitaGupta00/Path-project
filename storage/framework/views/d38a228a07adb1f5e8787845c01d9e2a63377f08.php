        ...
        <section class="welcome p-t-10">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="title-4">
                            Tasks - <?php echo e(\App\Models\tasks::count('id')); ?>
                        ...
                        <div class="table-data__tool">
                            ...
                            <div class="table-data__tool-right">
                                <button class="au-btn au-btn-icon au-btn--blue au-btn--small">
                                    <a href="<?php echo e(url('makeTask')); ?>" style="color: white">Add tasks +</a></button>
                            ...
                            <table class="table table-data2">
                                ...
                                <?php $__currentLoopData = $task; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="tr-shadow">
                                        ...
                                        <td>
                                            <span class="block-email"><?php echo e($item->decs ?? ''); ?></span>
                                        </td>
                                        <td class="desc">Admin</td>
                                        <td><?php echo e($item->created_at ?? ''); ?></td>
                                        <td><?php echo e($item->last_date ?? ''); ?></td>
                                        <td><?php echo e(\App\Models\project::where('id', $item->project_id)->get('title')); ?></td>
                                        <td>
...
<!-- end document-->
<?php /**PATH /home/ankita/work/web/laravel/path-project/resources/views/tasksList.blade.php ENDPATH**/ ?>