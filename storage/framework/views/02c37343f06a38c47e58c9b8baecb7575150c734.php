            ...
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="<?php echo e(url('AddTask')); ?>" method="get" novalidate="novalidate">
                            <div class="form-group">
                                <label for="cc-payment" class="control-label mb-1">Title</label>
                                <input id="cc-pament" name="title" type="text" class="form-control"
                                       placeholder="Your task title" value="<?php echo e(old('title')); ?>">
                            </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input id="cc-exp" name="exp" type="date"
                                               class="form-control cc-exp" value="<?php echo e(old('exp')); ?>" data-val="true"
                            ...
                            <div class="form-group">
                                ...
                                <select name="project" id="select" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $project; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option><?php echo e($item->title); ?></option>
...
<?php /**PATH /home/ankita/work/web/laravel/path-project/resources/views/makeTask.blade.php ENDPATH**/ ?>